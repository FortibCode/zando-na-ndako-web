...
export default function DiasporaSlotPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-4 sm:px-6 lg:px-8 my-8 sm:my-14 flex-1">
      <CheckoutSteps current={2} firstLabel="Bénéficiaire" />
      <h1 className="text-xl sm:text-2xl font-black text-slate-900 text-center mb-1">Créneau de livraison</h1>
      <p className="text-sm text-slate-500 text-center mb-8">Quand souhaitez-vous que {beneficiaire.nom} soit livré(e) ?</p>

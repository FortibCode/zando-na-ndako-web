...
export default function ParametresPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-4 sm:px-6 lg:px-8 my-8 sm:my-14 flex-1">
      <h1 className="text-2xl sm:text-3xl font-black text-slate-900 mb-1">{t("settings.title", "Paramètres")}</h1>
      <p className="text-sm text-slate-500 mb-6">{t("settings.subtitle", "Préférences de l'application")}</p>

      <div className="p-5 rounded-2xl border border-slate-200 bg-white space-y-3 mb-4">

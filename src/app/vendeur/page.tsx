  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {data.statut_validation !== "valide" && (
        <div className="flex items-center gap-2.5 p-4 rounded-2xl bg-amber-50 border border-amber-200 text-sm font-bold text-amber-800">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Link href="/vendeur/produits/nouveau" className="p-5 rounded-2xl border border-slate-200 bg-white hover:border-[#0B2545]/30 hover:shadow-md transition-all">
        ...
        <Link href="/vendeur/commandes" className="p-5 rounded-2xl border border-slate-200 bg-white hover:border-[#0B2545]/30 hover:shadow-md transition-all">
        ...
        <Link href="/vendeur/revenus" className="p-5 rounded-2xl border border-slate-200 bg-white hover:border-[#0B2545]/30 hover:shadow-md transition-all">

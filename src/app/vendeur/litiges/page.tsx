...
import { fetchVendeurLitiges, fetchLitigeMotifs, fullName, type Litige, type LitigeMotifOption } from "@/lib/api";
            ...
            <Link key={l.id} href={`/vendeur/litiges/${l.id}`}
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-slate-500 mt-0.5 truncate">
                  {motifs.find((m) => m.id === l.motif)?.label || l.motif} · {fullName(l.plaignant) || t("vendor.common.clientFallback", "Client")} · {t("vendor.litiges.orderPrefix", "Commande")} {l.commande?.numero_commande}
                </p>
